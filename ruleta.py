...
pyplot.grid()
pyplot.xlim(0, 1000)
pyplot.plot(x, [frEsperado(i) for i in x])
...
pyplot.xlim(0, n)
pyplot.ylim(0, 36)
pyplot.plot(x, [promEsperado(i) for i in x])
pyplot.xlabel('n (número de tiradas)')
...
pyplot.xlim(0, n)
pyplot.ylim(0, 36)
pyplot.plot(x, [desvEsperado(i) for i in x])
pyplot.xlabel('n (número de tiradas)')
...
pyplot.xlim(0, n)
pyplot.ylim(0, 200)
pyplot.plot(x, [varianzaEsperado(i) for i in x])
pyplot.xlabel('n (número de tiradas)')
